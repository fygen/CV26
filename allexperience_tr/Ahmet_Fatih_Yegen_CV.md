# Ahmet Fatih Yegen's CV

- Phone: +90 505 034 00 09
- Email: [fatihyegen.09@gmail.com](mailto:fatihyegen.09@gmail.com)
- Location: İstanbul, Türkiye
- Website: [fygen.github.io](https://fygen.github.io/)
- LinkedIn: [fatihyegen](https://linkedin.com/in/fatihyegen)
- GitHub: [fygen](https://github.com/fygen)
...
# Experience
## **Alpler Ziraat Aletleri A.Ş.**, Yazılım Geliştirme Uzman Mühendisi -- Aydın, Türkiye
...
## **Akasya Teknoloji̇ ve Bi̇li̇şim A.Ş.**, Yazılım Geliştirme Uzmanı -- İstanbul, Türkiye
...
## **Port Kargo Ve Loji̇sti̇k A.Ş.**, Yazılım Geliştirme Uzmanı -- İstanbul, Türkiye
...
## **Alpler Ziraat Aletleri A.Ş.**, Otomasyon ve Bakım Geliştirme Mühendisi -- Aydın, Türkiye
...
## **Uğur Soğutma Makinaları San. ve Tic. A.Ş.**, Mühendis Stajyeri -- Aydın, Türkiye
...
## **HAUS Santrifüj Teknolojileri**, AR-GE Araştırma Stajyeri -- Aydın, Türkiye
...
# Projects
## **Gelişmiş Modüler IoT ve Web Mimarisi**
...
# Education
## **Pamukkale Üniversitesi**, Elektrik-Elektronik Mühendisliği, Lisans -- Denizli, Türkiye
...
## **42 İstanbul**, Yoğunlaştırılmış Yazılım Mühendisliği Müfredatı, Sert. -- İstanbul, Türkiye
...
## **Varşova Teknoloji Üniversitesi (Warsaw University of Technology)**, Elektrik Mühendisliği & Elektronik ve Bilgi Teknolojileri (Erasmus+), Değ. -- Varşova, Polonya
...
# Skills
**Programlama Dilleri:** C#, TypeScript, JavaScript, Python, C, SQL, BASH, PowerShell

**Arka Yüz & Mimari:** .NET Core, Entity Framework, Node.js, Express.js, Django, RESTful APIs, GraphQL, Microservices, Onion Architecture

**Ön Yüz & Mobil:** React, React Native, Next.js, SvelteKit, Blazor WebAssembly, HTML5, CSS3, SCSS

**Veritabanı & DevOps:** MSSQL, PostgreSQL, MySQL, SQLite, Docker, Git, GitHub Actions, WSL, Linux (Ubuntu/Kali)

**Endüstriyel Otomasyon:** PLC Programlama (ISPsoft, DOPSoft), MQTT, Modbus, Node-RED, n8n, KUKA Robotik

# Certificates
## **Backend Development and APIs**

FreeCodeCamp Sertifikası
