...
# Projects
## **Advanced Modular Web & AI Automation Architecture**
...
# Skills
**Core Stack:** TypeScript, JavaScript, Python, C#, SQL, BASH

**Frontend & Web:** Next.js, SvelteKit, React, Tailwind CSS, HTML5/SCSS, Micro-Frontends

**Backend & AI Automation:** Node.js, .NET Core, Express.js, n8n, Node-RED, RESTful APIs, GraphQL

**Database & DevOps:** PostgreSQL, Drizzle ORM, Entity Framework, Docker, GitHub Actions, Linux (Ubuntu)
