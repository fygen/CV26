...
# Projects
## **Gelişmiş Modüler Web & AI Otomasyon Mimarisi**
...
# Skills
**Temel Teknolojiler:** TypeScript, JavaScript, Python, C#, SQL, BASH

**Ön Yüz & Web:** Next.js, SvelteKit, React, Tailwind CSS, HTML5/SCSS, Micro-Frontends

**Arka Yüz & AI Otomasyon:** Node.js, .NET Core, Express.js, n8n, Node-RED, RESTful APIs, GraphQL

**Veritabanı & DevOps:** PostgreSQL, Drizzle ORM, Entity Framework, Docker, GitHub Actions, Linux (Ubuntu)
